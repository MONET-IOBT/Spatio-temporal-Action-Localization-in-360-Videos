...
from data import AnnotationTransform, UCF24Detection, BaseTransform, UCF24_CLASSES, detection_collate, v1,v2,v3,v4,v5
...
def test_net(net, save_root, exp_name, input_type, dataset, iteration, num_classes, outfile, thresh=0.5 ):
    ...
    args.client_socket.connect(('10.0.1.240', 8487))
